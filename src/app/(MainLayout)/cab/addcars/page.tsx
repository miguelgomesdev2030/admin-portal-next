            ...
            <div className="card-body">
              <form className="theme-form mega-form">
                <div className="mb-3">
                  ...
                  <input className="form-control" type="text" placeholder="Car Name" />
                </div>
                <div className="mb-3">
                  <label className="form-label-title ">Upload Car Image here</label>
                   <DropZoneCommon/>
                </div>
                <div className="mb-3">
                ...
                <div className="mb-3">
                  ...
                  <div className="input-group mb-3"><span className="input-group-text">$
                    ...
                    <input className="form-control" placeholder={"20"} type="text" aria-label="Amount (to the nearest dollar)" />
                  </div>
                </div>
                <div className="mb-3">
                  <label htmlFor="car-type" className="form-label-title ">Car Type</label>
                  <select id="car-type" className="js-example-basic-single col-sm-12">
